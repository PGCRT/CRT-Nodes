...
if 'CRT_NODES_INITIALIZED' not in globals():
    ...
    from .py.smart_controlnet_apply import SmartControlNetApply, ClearPreprocessorCache
...
# These need to be defined outside the guard so they're always available
NODE_CLASS_MAPPINGS = {
...
NODE_DISPLAY_NAME_MAPPINGS = {
    ...
    "ClearPreprocessorCache": "Clear Preprocessor Cache (CRT)",
